 ...
 * Projet_vf.java
 * 
 * Copyright 2022 Elève <Elève@GRAND-H3N0F1KST>
 * 
...
public class Projet_vf {
	
	public static void trouverlesmots () throws IOException {
		...
		while((ligne = entree.readLine()) != null){ // Tant que la ligne du dictionnaire n'est pas vide
            ...
            for (i = 0; i <= trimmed.length() - 1; i++){
                  ...
                  for (j = 0; j <= trimmed.length() - 1; j++){
                        list3[j] = trimmed.charAt(j);  // Mettre les lettres du mot dans le troisième tableau
                        if (list1[i] == list3[j]){
		...
		System.out.println("Pour repondre a vos contraintes, il vous faudra saisir les lettres imposees dans le mot.");
		System.out.println("Saisir un 0 lorsqu'aucune lettre n'est demandee dans la position.");
	...
	public static void main (String[] args) throws IOException {
		...
		// variables
		int scoregisele, scoreantoine, pointmancheantoine, pointmanchegisele, continuer ;
		
		//avant la partie
		System.out.println ("debut de la partie") ;
		scoregisele = 0 ;
		scoreantoine = 0 ;
		pointmancheantoine = 0 ;
		pointmanchegisele = 0 ;
		continuer = 1 ;
		
		//premier mot posé
	trouverlesmots () ;
	System.out.println ("Entrez le nombre de points marques") ;
	pointmancheantoine = Lire.i() ;
	scoreantoine = scoreantoine + pointmancheantoine ;
	pointmancheantoine = 0 ;
	
	//premier mot de mamie
	pointmanchegisele = (int)((Math.random()*10)+1) ;
	System.out.println ("mamie pose un mot a " +pointmanchegisele+ " points") ;
	scoregisele = scoregisele + pointmanchegisele ;
	pointmanchegisele = 0 ;
	
	while (continuer == 1) {
		//début de la stratégie
		if (scoreantoine > 1.2*scoregisele) {
			//Antoine joue
			System.out.println("Vos score ont trop d'ecart, nous vous conseillons de jouer un mots valant peu de points pour ne pas vous faire demasquer") ;
			trouverlesmots () ;
			System.out.println("Nous vous rappelons de jouer un mot qui vaut pas beaucoup de points") ;
			pointmancheantoine = Lire.i();
			scoreantoine = scoreantoine + pointmancheantoine ;
			pointmancheantoine = 0 ;
			...
			System.out.println("Mamie a "+scoregisele+" et Antoine a "+scoreantoine+"") ;	
		}
		
		//pas de stratégie car le score n'est pas trop grand	
		else ;
	
		//Antoine joue
		trouverlesmots () ;
		System.out.println ("Entrer le nombre de points marques") ;
		pointmancheantoine = Lire.i() ;
		scoreantoine = scoreantoine + pointmancheantoine ;
		pointmancheantoine = 0 ;
		...
		//Gisèle joue
		pointmanchegisele = (int)((Math.random()*10)+1) ;
		System.out.println ("mamie pose un mot a un mot a " +pointmanchegisele+ " points") ;
		scoregisele = scoregisele + pointmanchegisele ;
		pointmanchegisele = 0 ;
	
		System.out.println("Gisele a "+scoregisele+" et Antoine a "+scoreantoine+"") ;
		
		//pour arrêter la partie
		System.out.println("continuer la partie? 1 pour continuer, 0 pour  arreter") ;
		continuer =  Lire.i() ;
		while (continuer !=0 && continuer != 1)  {
			System.out.println("valeur fausse, 1 pour continuer, 0 pour  arreter ") ;
			continuer =  Lire.i() ;
		}
	}
	System.out.println("fin de la partie, Gisele a "+scoregisele+" et Antoine a "+scoreantoine+"") ;
}
}
